...
model.save('/Users/TonyFaieta/Desktop/handwriting_model.h5')

import coremltools
coreml_model = coremltools.converters.keras.convert(model, input_names=['image'], image_input_names='image')

coreml_model.author = 'Tony Faieta'
coreml_model.license = 'MIT'
coreml_model.short_description = 'Predicts handwritten characters from 1-9.'
...
coreml_model.save('/Users/TonyFaieta/Desktop/Handwriting.mlmodel')
